 ...
 * Document Clean Code - Vanilla JS (Sécurisé CSRF & Sans alert)
 */
document.addEventListener("DOMContentLoaded", () => {
    
    // Récupération dynamique de l'URL de base (Remplace la variable globale)
    const baseTag = document.querySelector('base');
    const baseUrl = baseTag ? baseTag.getAttribute('href') : '/';

    // Récupération du jeton CSRF depuis l'attribut data-csrf injecté en Phase 2
    ...
    // =========================================================================
    // SYSTÈME DE TOAST PERSONNALISÉ (Remplace les alert() natifs bloquants)
    // =========================================================================
    function showAccountToast(message, type = 'danger') {
        ...
        const textNode = document.createTextNode(message); // SÉCURITÉ : Anti-XSS
    ...
    // Gestion propre du routage après soumission d'un formulaire (PRG Pattern)
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.has('success') || urlParams.has('error')) {
        switchTab('tabInfo');
        // Nettoyage de l'URL pour une meilleure UX
    ...
    // =========================================================================
    // 2. AFFICHER/MASQUER LE MOT DE PASSE (ICONE OEIL)
    // =========================================================================
    ...
    // =========================================================================
    // 4. ACTIVATION D'UN CODE DE REDUCTION (Sécurisé CSRF)
    // =========================================================================
    ...
    // =========================================================================
    // 5. GESTION DES DÉTAILS DE LA COMMANDE (MODALE FACTURE AJAX)
    // =========================================================================
    ...
    document.addEventListener('click', async (e) => {
        ...
        if (btnAdd) {
            ...
            try {
                ...
                // On utilise la balise cachée de la page, ou le token global si présent
                ...
                if (response.ok && !responseData.error) {
                    // Cart.php renvoie l'array complet du panier (format original)
