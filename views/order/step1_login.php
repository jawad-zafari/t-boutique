<div class="checkout-stepper-container">
    ...
    <div class="checkout-auth-split-grid">
        ...
        <div class="auth-action-card card-bg-white text-center">
            ...
            <a href="<?= URL ?>Login/index" class="btn-stepper-primary btn-full-width" aria-label="Se connecter à mon compte client">Se connecter</a>
        </div>
        ...
        <div class="auth-action-card card-bg-white text-center">
            ...
            <a href="<?= URL ?>Register/index" class="btn-stepper-secondary btn-full-width margin-bottom-sm" aria-label="Créer un nouveau compte utilisateur">Créer un compte</a>
